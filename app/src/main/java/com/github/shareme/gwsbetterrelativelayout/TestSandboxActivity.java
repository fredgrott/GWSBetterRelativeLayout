...
public class TestSandboxActivity extends Activity implements OnClickListener {
    ...
    private static final int[] CLICKABLE_TESTS = new int[] { R.id.relative_position_test, R.id.visibility_test, R.id.dynamic_test,
            R.id.spring_test, R.id.comparison_test_1, R.id.comparison_test_2 };
